...
const Projects = forwardRef((props, ref) => {
  ...
  const projects = [
    {
      name: 'Noma', 
      desc: 'Noma is a rental management application. It helps renters and landlords keep track of properties, rent payments and other requests all in one place. Demo app coming soon.', 
